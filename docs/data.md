...
| [Numerics and vectors](numerics.md) | `SharpProspero.Numerics` | `Vector2`, `RectF`, scalar math, collision tests, a seedable random source, and a quadtree. |
| [Buffers and encodings](buffers.md) | `SharpProspero.Buffers` | Reading and writing binary data, ring buffers, and hex/Base64/Base32. |
...
| [Hashing and checksums](security.md) | `SharpProspero.Security` | CRC-32, MD5, SHA-1, SHA-2, SHA-3, and HMAC. |
