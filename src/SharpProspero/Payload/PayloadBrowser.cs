...
/// <c>sceSystemServiceLaunchWebBrowser</c> from <c>libSceSystemService</c>, which is the
/// mechanism the SDK <c>browser</c> sample uses.
/// </summary>
/// <remarks>
/// <para>The browser launch requires an active user-service session. The SDK <c>browser</c>
/// sample initialises the user service in a constructor attribute before calling
/// <c>sceSystemServiceLaunchWebBrowser</c> in <c>main</c>. A payload should call
